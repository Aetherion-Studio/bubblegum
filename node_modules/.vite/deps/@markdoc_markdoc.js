...
var Class = class {
  ...
  transform(value) {
    if (!value || typeof value === "string")
      return value;
    const classes = [];
    for (const [k, v] of Object.entries(value != null ? value : {}))
      if (v)
        classes.push(k);
    return classes.join(" ");
  }
...
var transformer_default = {
  ...
  attributes(node2, config = {}) {
    var _a;
    const schema = (_a = this.findSchema(node2, config)) != null ? _a : {};
    const output = {};
  ...
  switch (n.type) {
    ...
    case "text": {
      ...
      if (ast_default.isAst(content))
        yield OPEN + SPACE;
      yield* typeof content === "string" ? escapeMarkdownCharacters(content, /[_*~]/g) : formatValue(content, no);
      if (ast_default.isAst(content))
        yield SPACE + CLOSE;
      break;
    }
...
function render(node2) {
  ...
  let output = `<${name}`;
  for (const [k, v] of Object.entries(attributes != null ? attributes : {}))
...
function validateFunction(fn, config) {
  ...
  for (const [key, { required }] of Object.entries((_c = schema.parameters) != null ? _c : {}))
